...
pkgDistFile = path.join(pkgDir, 'include/data/dist.json'),
pkgShellDir = path.join(pkgDir, 'include/shell'),
pkgActivateFile = path.join(pkgDir, 'include/shell/activate.sh'),
pkgConfigFile = path.join(pkgDir, 'include/data/config.json'),  
pkgFullDistFile = path.join(pkgDir, 'include/data/fullDist.json');
