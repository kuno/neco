  ...
  path.exists(configFile, function(exists) {
    if (exists) {
      ...
      keys.forEach(function(k) {
        Object.defineProperty(config, k, {value:content.k, writable:true, enumerable:true, configurable:true});
      });
    }
  });
  ...
  if (id) {
    ...
    path.exists(ecosystemConfigFile, function(exists) {
      if (exists) {
        ...
        keys = Object.keys(content);
        keys.forEach(function(k) {
          Object.defineProperty(config, k, {value:content.k, writable:true,enumerable:ture, configurable:true});
        });
      }
    });
  }
