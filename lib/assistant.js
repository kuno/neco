...
exports.getRelease = function(target) {
  ...
  distFile = process.config.distFile;
...
exports.getEcosystem = function(id) {
  var recordFile = process.config.recordFile, ecosystem = null;
...
exports.getDateTime = function() {
  var date = new Date(), time = date.getTime(),
      timeFormat = process.config.timeFormat;
  if (timeFormat === 'GMT') {
...
exports.getNodeInstallScript = function() {
  var script = null, shellDir = process.config.shellDir;
...
exports.getNPMInstallScript = function() {
  var shellDir = process.config.shellDir,
...
exports.writeGlobalConfigFile = function(id, next) {
  var error, root = process.config.root, 
  cleannedConfig = cleanGlobalConfig(process.config),
...
exports.writeEcosystemConfigFile = function(id) {
  ...
  cleannedConfig = cleanEcosystemConfig(process.config),
  configData = JSON.stringify(cleannedConfig),   
...
exports.findlongestID = function() {
  ...
  recordFile = process.config.recordFile;
