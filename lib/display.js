...
rightParentheses = color(']', 'yellow'),
msgHead = leftParentheses+color('Neco Message\n', 'green+bold')+rightParentheses+':', msgbody, 
wrgHead = leftParentheses+color('Neco Warning\n', 'yellow+bold')+rightParentheses+':', wrgBody, 
errHead = leftParentheses+color('Neco Error\n', 'red+bold')+rightParentheses, errBody, 
sgtHead = leftParentheses+color('Suggestion\n', 'cyan')+rightParentheses, stgBody,
expHead = leftParentheses+color('Examples\n', 'cyan')+rightParentheses, expBody,
