...
function _message(information, suggestion, example, cmd) {
...
function _stdout(information) {
  util.print(''+information);
}

function _warning(information, suggestion, example, cmd) {
...
function _error (information, suggestion, example, cmd) {
...
log.on('message', _message);
log.on('warning', _warning);
log.on('stdout', _stdout);
log.on('error', _error);
/*
