...
causeHead = leftParentheses+color('Cause','cyan+bold')+rightParentheses, causeBody,
...
function _logError (error) {
  ...
  console.log('');
  console.log(causeHead+'  '+causeBody);
  console.log('');
  console.log(sgtHead+'  '+color(sgtBody, 'magenta'));
