...
exports.run = function(argv) {
  if (argv.target === undefined) {
    ...
    console.log('      Useage: neco create <id> [version]');
    console.log('');
    ...
    console.log('      Usage:  neco list <id>');
    console.log('');
    console.log('  update      -  update local dist date to latest');
    console.log('      Usage   neco update');
    console.log('');
    console.log('  find        -  find out available node release(s)');
    console.log('      Usage:  neco find [stable, unstable, latest, version]');
    console.log('');
    ...
    console.log('');
    console.log('  completion  -  prints all commands');
    console.log('      Usage:  neco completion');
    console.log('');
