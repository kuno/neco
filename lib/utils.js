...
exports.fillSpace = function(type, string, config) {
  var i, gap, standard;

  if (type === 'id') {
    standard = config.idLenStandard;
  } else if (type === 'version') {
    standard = config.verLenStandard;
  } else if (type === 'link') {
    standard = config.linkLenStandard;
  } else if (type === 'size') {
    standard = config.sizeLenStandard;
  } else {
    standard = 18;
  }
