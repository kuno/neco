...
exports.compareVersion = function(versionA, versionB) {
  var a = versionA.split('.'), b = versionB.split('.'), isBigger = false;
...
exports.getSuitedNPM = function(version) {
  var len, node, npm = null;
  var target = version;
  var biggerThan = exports.compareVersion;
  ...
  for (var i = 0; i < len; ++i) {
    ...
    if (biggerThan(target, minima) === true) {
      npm = coulps[i].npm;
      break;
    }
  }
